<template>
  <div class="flex flex-col content-center m-auto w-32 text-center mt-6">
    ...
    >
      ...
      <span
        data-test="age-test"
        class="font-normal text-profile-dark-grayish-blue ml-2"
        >{{ age }}</span
      >
    </h1>
    <h2
      data-test="location-test"
      class="font-normal text-profile-dark-grayish-blue text-sm mt-2"
    >
      {{ location }}
    </h2>
  </div>
